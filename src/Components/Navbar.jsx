...
function Navbar() {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // تأكد من تعريف هذا المتغير
    ...
    <nav className="bg-[var(--mainColor)] w-full m-auto ">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="hidden lg:ml-6 lg:flex items-center h-full space-x-4">
            ...
            {/* Added Clients Reviews Link */}
            <a
              href="/#clientsReviews"
              className={`rounded-sm px-3 h-full flex items-center py-2 text-sm font-medium text-gray-300 border-b-4 ${isActive('#clientsReviews')} hover:border-[var(--secondryColor)] transition-all ease-in-out tabLink`}
            >
              Client Reviews
            </a>

            <a
              href="/#Oursuccesspartners"
              className={`rounded-sm px-3 h-full flex items-center py-2 text-sm font-medium text-gray-300 border-b-4 ${isActive('#Oursuccesspartners')} hover:border-[var(--secondryColor)] transition-all ease-in-out tabLink`}
            >
          ...
          <div className="hidden lg:flex items-center justify-center sm:items-stretch sm:justify-start">
            <div>
              <a
                href='#contactUs'
                className="active:scale-95 transition-all ease-in-out text-black bg-[var(--secondryColor)] w-[174.11px] h-[43.31px] rounded-[8.65px] hover:bg-[var(--secondryColorDark)] text-center flex justify-center items-center"
              >
                Contact Us
              </a>
            </div>
      ...
      <div className={`lg:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu">
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          <a
            href="/#clientsReviews"
            className={`block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white ${isActive('#clientsReviews')}`}
          >
            Client Reviews
          </a>
          <a
            href="/#Oursccesspartners"
            className={`block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white ${isActive('#Oursuccesspartners')}`}
          >
            Our Success Partners
          </a>
          ...
          <a
            href='/#contactUs'
            className="active:scale-95 transition-all ease-in-out text-white bg-[var(--secondryColor)] w-full h-[43.31px] rounded-[8.65px] hover:bg-[var(--secondryColorDark)] text-center flex justify-center items-center"
          >
            Contact Us
          </a>
        </div>
